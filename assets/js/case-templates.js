...
const METHOD_OUTPUTS = {
  ...
  "merger-model": [["buyer_eps", "synergy_after_tax"], ["buyer_eps", "synergy_after_tax", "fee_after_tax", "purchase_price_allocation"], ["buyer_eps", "synergy_after_tax", "fee_after_tax", "purchase_price_allocation", "integration_after_tax", "pro_forma_eps_y2", "goodwill", "ppa_step_up_value", "dtl_value", "write_offs_value", "combined_assets", "combined_liabilities", "combined_balance_check", "synergy_npv", "accretion_dilution_y2_pct", "accretion_dilution_y3_pct"]],
};
...
function publicInputs(theme, difficulty, random) {
  ...
  if (difficulty !== "easy") { const minimumCash = n(100, 250); Object.assign(data, { minimum_cash: minimumCash, buyer_cash: minimumCash + n(100, 450), debt_rate: p(.045, .075), cash_yield: p(.02, .04), ppa_amortization_years: 5, synergy_discount_rate: p(.08, .12), ppa_step_up: n(20, 100), stock_mix_floor: p(.15, .35), transaction_costs: n(10, 35) }); }
