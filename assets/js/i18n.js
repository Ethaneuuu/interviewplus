...
const caseOutputLabels = {
  ufcf_y1: ["Flux de trésorerie disponible non endetté N+1", "Unlevered free cash flow N+1"], ufcf_y2: ["Flux de trésorerie disponible non endetté N+2", "Unlevered free cash flow N+2"], ufcf_y3: ["Flux de trésorerie disponible non endetté N+3", "Unlevered free cash flow N+3"], ufcf_y4: ["Flux de trésorerie disponible non endetté N+4", "Unlevered free cash flow N+4"], ufcf_y5: ["Flux de trésorerie disponible non endetté N+5", "Unlevered free cash flow N+5"],
  ...
  ebitda_y1: ["EBITDA N+1", "EBITDA N+1"], ebitda_y2: ["EBITDA N+2", "EBITDA N+2"], ebitda_y3: ["EBITDA N+3", "EBITDA N+3"], discount_factor_y1: ["Facteur d'actualisation N+1", "Discount factor N+1"], discount_factor_y5: ["Facteur d'actualisation N+5", "Discount factor N+5"], capex_y1: ["Capex N+1", "Capex N+1"], nwc_y1: ["BFR N+1", "NWC N+1"],
  entry_ev: ["Valeur d'entreprise d'entrée", "Entry enterprise value"], entry_equity: ["Valeur des capitaux propres d'entrée", "Entry equity value"], sources_total: ["Total des sources", "Total sources"], uses_total: ["Total des emplois", "Total uses"], fcf_y1: ["Flux de trésorerie disponible N+1", "Free cash flow N+1"], fcf_y2: ["Flux de trésorerie disponible N+2", "Free cash flow N+2"], fcf_y3: ["Flux de trésorerie disponible N+3", "Free cash flow N+3"], fcf_y4: ["Flux de trésorerie disponible N+4", "Free cash flow N+4"], fcf_y5: ["Flux de trésorerie disponible N+5", "Free cash flow N+5"],
  debt_y1: ["Dette N+1", "Debt N+1"], debt_y2: ["Dette N+2", "Debt N+2"], debt_y3: ["Dette N+3", "Debt N+3"], debt_y4: ["Dette N+4", "Debt N+4"], debt_y5: ["Dette N+5", "Debt N+5"], exit_ev: ["Valeur d'entreprise de sortie", "Exit enterprise value"], exit_equity: ["Valeur des capitaux propres de sortie", "Exit equity value"], mom: ["Multiple de capital investi", "Money-on-money multiple"], irr: ["Taux de rentabilité interne", "Internal rate of return"],
  sponsor_equity: ["Fonds propres du sponsor", "Sponsor equity"], debt_paydown_y1: ["Remboursement de dette N+1", "Debt paydown N+1"], interest_y1: ["Intérêts N+1", "Interest N+1"], revolver_draw: ["Tirage de revolver", "Revolver draw"], pik_interest_y1: ["Intérêts PIK N+1", "PIK interest N+1"], management_proceeds: ["Produit du management", "Management proceeds"],
...
const pairs = [
  ...
  ["Reprendre", "Resume"],
  ["Sessions & progression", "Sessions & progress"],
  ["Session en pause", "Paused session"],
  ["Mettre en pause", "Pause"],
  ["Quitter", "Quit"],
  ["Mettre en pause et sauvegarder", "Pause and save"],
  ["Quitter définitivement", "Quit for good"],
  ["Continuer", "Continue"],
  ["Une session est en cours. Que voulez-vous faire ?", "A session is in progress. What would you like to do?"],
  ["Progression sauvegardée. Vous pourrez reprendre cette session depuis Mon espace.", "Progress saved. You can resume this session from My account."],
  ["Profil", "Profile"],
  ["Connexion", "Sign in"],
  ...
  ["Les questions viennent des meilleures banques", "Questions come from the top banks"],
  ["Voir InterviewPlus en action.", "See InterviewPlus in action."],
  ["Apercu video — Nouvelle session", "Video preview — New session"],
  ["Tests 100% personnalisables", "100% customisable tests"],
  ["Nombre de questions, theme cible ou tirage aleatoire, timer global : chaque session est configuree avant de commencer.", "Number of questions, target topic or random draw, overall timer: every session is configured before it starts."],
  ["Apercu video — Cas pratiques", "Video preview — Practical cases"],
  ["Questions pertinentes, cas reels", "Relevant questions, real cases"],
  ["Des mises en situation issues des meilleurs process M&A, pas des questions generiques trouvees en ligne.", "Scenarios drawn from top-tier M&A processes, not generic questions found online."],
  ["Apercu video — Generation quotidienne", "Video preview — Daily generation"],
  ["Jamais deux fois la meme question", "Never the same question twice"],
  ["Base entretenue chaque jour, generation automatique de variantes : des tests renouvelables et uniques a chaque session.", "Bank maintained daily, automatic variant generation: fresh, unique tests on every session."],
  ["Que voulez-vous travailler ?", "What do you want to work on?"],
  ["Choisissez un format d'entrainement.", "Choose a training format."],
  ["Session questions", "Question session"],
  ["Entretien chronometre : questions techniques, comportementales et sectorielles avec correction detaillee.", "Timed interview: technical, behavioral and industry questions with detailed feedback."],
  ["Construisez un modele DCF, LBO ou merger sous pression, sur un cas genere avec une entreprise et des donnees uniques.", "Build a DCF, LBO or merger model under pressure, on a case generated with a unique company and data set."],
  ["Reprenez une session, consultez votre historique et vos axes de travail.", "Resume a session, review your history and your areas to work on."],
  ["Saisie", "Input"],
  ["Chargement du cas…", "Loading the case…"],
  ["Entrainez-vous maintenant.", "Train now."],
];
